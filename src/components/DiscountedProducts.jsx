              ...
              <div className="flex items-center">
                <Menu as="div" className="relative inline-block text-left">
                  ...
                  >
                    <div className="py-1">
                      {sortOptions.map((option) => (
                        <MenuItem key={option.name} onClick={handleSortOption} ref={`${option.name==="Discount" ? discount:""}`}>
                          <Link
                            to={option.href}
                 ...
                 <div
                  className={`w-full   ${
                    loading
                      ...
                      : "flex flex-wrap justify-center gap-4 gap-y-12 max-xl:gap-3 max-xl:gap-y-10 max-lg:gap-2 max-lg:gap-y-12 mx-auto max-w-screen-lg "
                  }`}
                >
                  <Toaster />
                  {loading ? (
